...
import frc.robot.commands.arm.dropArmSpecific;
import frc.robot.commands.arm.dropArmSpecific2;
import frc.robot.commands.arm.dropArmSpecific3;
...
public class nonbump extends SequentialCommandGroup {
...
//   List<EventMarker> markers = new ArrayList<EventMarker>();
  public nonbump(SwerveDrivetrain drivetrain, IntakeSubsystem intake, 
    ...
    addCommands(
      ...
      new SequentialCommandGroup(
        ...
        new ParallelDeadlineGroup(
          ...
          new dropArmSpecific3(arm, drivetrain),
